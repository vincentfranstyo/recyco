    ...
    return (
        <SafeAreaView style={styles.container}>
          ...
          />
            ...
            <View style={styles.section}>
              <Text style={styles.sectionTitle}><FontAwesome5 name="truck" size={16} color="#2E6464" /> Informasi Kurir</Text>
              <Text style={styles.sectionText}>Sihabuddin - 082323232323</Text>
            </View>
    
            <View style={styles.section}>
              <View style={styles.addressHeader}>
                <Text style={styles.sectionTitle}><Ionicons name="location-outline" size={18} color="#2E6464" /> Alamat Penjemputan</Text>
                <TouchableOpacity>
