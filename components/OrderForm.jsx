...
const OrderForm = ({navigation}) => {
    ...
    const isInsufficientBalance = () => {
        if (currentUser.balance < totalPrice) {
            Alert.alert('You are out of balance', 'Please top up in the profile page');
            return true;
        }
        return false;
    }
    ...
    const makeHistory = async (currentUser, order) => {
        ...
        const orderHistory = {
            ...
            loadSchedule: order.loadSchedule,
        ...
        <>
            <View className={'flex bg-transparent w-full max-h-[70%] max-w-full justify-between py-5'}>
                ...
                <View className={'w-full max-h-[35%] flex bg-white rounded-xl'} style={style.glow}>
                    ...
                    <View className={'w-full p-2 bg-transparent justify-between flex flex-row'}>
                        <Text className={'text-left text-xs max-w-[65%] text-[#2C6262] pt-1'}
                ...
                <View
                    ...
                    <Text className={'text-md text-black max-h-[40%] text-center py-2'}
